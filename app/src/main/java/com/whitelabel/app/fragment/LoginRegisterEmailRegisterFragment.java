...
//                    img3_error.setVisibility(View.INVISIBLE);
                ...
                case R.id.et_phone_number:
                    ...
                    if(et_phone_number.getText().toString().trim().equals("")) {
                        ...
                        tv_phone_text2.setTextColor(getResources().getColor(R.color.colorAccent));
                    }
...
//                        img3_error.setVisibility(View.VISIBLE);
            ...
            case R.id.et_phone_number:
                ...
                tv_phone_text2.setTextColor(getResources().getColor(R.color.label_saved));
...
//                    img3_error.setVisibility(View.VISIBLE);
                    iv_phone_correct.setVisibility(View.INVISIBLE);
                    tv_phone_text2.setTextColor(getResources().getColor(R.color.redC2060A));
