 ...
 */
public class ProductActivity extends BaseActivitySearchCart implements ProductDetailCallback, OnPageChangeListener, View.OnClickListener {
...
//    mRLAddToWishlistBig  ,ivHeaderBarWishlist, ivHeaderBarWishlist2,mIVHeaderBarWishlist,mIVHeaderBarWishlist2 , mRLAddToWishlistSmall
...
//        setTitle("");
//        setLeftMenuIcon(JToolUtils.getDrawable(R.drawable.draw_v2_back));
...
//            TODO MAXQTY
    ...
    public void outOfStockToWishlist() {
        ...
        if (bottomBarLp != null) {
            ...
            bottomBarLp.height = JDataUtils.dp2Px(0);
            llBottomBar.setLayoutParams(bottomBarLp);
        }
    }
