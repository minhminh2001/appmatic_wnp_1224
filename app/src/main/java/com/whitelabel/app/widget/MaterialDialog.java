...
public class MaterialDialog {
    ...
    private class Builder {
        ...
        public void setPositiveButton(String text, final View.OnClickListener listener) {
            ...
            button.setTextColor(Color.parseColor("#92018d"));
            button.setText(text);
        ...
        public  void setListViewHeightBasedOnChildren(ListView listView) {
            ...
            for (int i = 0; i < listAdapter.getCount(); i++) {
                ...
                JLogUtils.i("MaterialDialog","=========="+listItem.getMeasuredHeight());
                if(i<4){
            ...
            if(listAdapter.getCount()>=4) {
                ViewGroup.LayoutParams param1= (ViewGroup.LayoutParams) listView.getLayoutParams();
                param1.height=viewHeight;
            ...
            listView.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    if (event.getAction() == MotionEvent.ACTION_UP) {
                        mMessageContentRoot.requestDisallowInterceptTouchEvent(false);
                    } else {
                        mMessageContentRoot.requestDisallowInterceptTouchEvent(true);
                    }
                    return false;
                }
            });
