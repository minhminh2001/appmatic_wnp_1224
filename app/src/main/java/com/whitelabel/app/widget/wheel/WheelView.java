...
package com.whitelabel.app.widget.wheel;
...
import com.whitelabel.app.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     */
    private int[] SHADOWS_COLORS = new int[]{0x99EAEAEA,
            0x99EAEAEA, 0x99EAEAEA};
    // Wheel Values
    ...
    private int getItemHeight() {
        ...
        if (itemsLayout != null && itemsLayout.getChildAt(0) != null) {
            ...
            if(itemHeight==0){
                itemHeight=JDataUtils.dp2px(getContext(),45);
            }

            return itemHeight;
        }
        itemHeight=getHeight() / visibleItems==0?JDataUtils.dp2Px(45):getHeight()/visibleItems;
        if(itemHeight==0){
            itemHeight=JDataUtils.dp2px(getContext(), 45);
        }
        return itemHeight;
    ...
    private void drawShadows(Canvas canvas) {
        int height = (int)(getHeight()-getItemHeight())/4*2;
