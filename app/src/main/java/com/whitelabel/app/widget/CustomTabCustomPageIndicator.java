 ...
 */
public class CustomTabCustomPageIndicator extends HorizontalScrollView {
    // @formatter:off
    ...
    private int underlineColor = 0x000000;
    ...
    public CustomTabCustomPageIndicator(Context context) {
        this(context, null);
    }

    public CustomTabCustomPageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    @SuppressWarnings("ResourceType")
    public CustomTabCustomPageIndicator(Context context, AttributeSet attrs, int defStyle) {
...
//                }
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            if (tabsContainer != null && tabsContainer.getChildCount() > position && tabsContainer.getChildAt(position) != null) {
        ...
        private String crrTag="CustomTabCustomPageIndicator";
        @Override
        public void onPageSelected(int position) {
            JLogUtils.i(crrTag,"position:"+position);
