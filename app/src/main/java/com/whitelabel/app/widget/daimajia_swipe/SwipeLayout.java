package com.whitelabel.app.widget.daimajia_swipe;
...
public class SwipeLayout extends FrameLayout {
    ...
    public void open(boolean smooth, boolean notify) {
        ...
        if(closeOther&&swipeLayoutCallBack!=null) {
            swipeLayoutCallBack.swipeCallback(this, com.whitelabel.app.widget.daimajia_swipe.interfaces.SwipeLayoutCallBack.type_reall);
        }
        //save the open swipeLayout
        if(swipeLayoutCallBack!=null) {
            swipeLayoutCallBack.swipeCallback(this, com.whitelabel.app.widget.daimajia_swipe.interfaces.SwipeLayoutCallBack.type_add);
        }
    ...
    public void close(boolean smooth, boolean notify,boolean callback) {
        if(callback) {
            ...
            swipeLayoutCallBack.swipeCallback(this, com.whitelabel.app.widget.daimajia_swipe.interfaces.SwipeLayoutCallBack.type_re);
        }
        View surface = getSurfaceView();
        if (surface == null) {
            return;
