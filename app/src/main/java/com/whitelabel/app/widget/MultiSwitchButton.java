...
//	滑块颜色
	...
	public MultiSwitchButton(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(AttributeSet attrs) {
		...
		TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.MultiSwitchButton);
		if (ta != null) {
			thumbDrawable = ta.getDrawable(R.styleable.MultiSwitchButton_ThumbDrawable);
			thumbColor = ta.getColorStateList(R.styleable.MultiSwitchButton_ThumbColor);
			margin = ta.getDimension(R.styleable.MultiSwitchButton_ThumbMargin, margin);
			marginLeft = ta.getDimension(R.styleable.MultiSwitchButton_ThumbMarginLeft, margin);
			marginRight = ta.getDimension(R.styleable.MultiSwitchButton_ThumbMarginRight, margin);
			marginTop = ta.getDimension(R.styleable.MultiSwitchButton_ThumbMarginTop, margin);
			marginBottom = ta.getDimension(R.styleable.MultiSwitchButton_ThumbMarginBottom, margin);
			thumbWidth = ta.getDimension(R.styleable.MultiSwitchButton_ThumbWidth, thumbWidth);
			thumbHeight = ta.getDimension(R.styleable.MultiSwitchButton_ThumbHeight, thumbHeight);
			thumbRadius = ta.getDimension(R.styleable.MultiSwitchButton_ThumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
			backRadius = ta.getDimension(R.styleable.MultiSwitchButton_BackRadius, thumbRadius + density * 2f);
			backDrawable = ta.getDrawable(R.styleable.MultiSwitchButton_BackDrawable);
			backColor = ta.getColorStateList(R.styleable.MultiSwitchButton_BackColor);
			backMeasureRatio = ta.getFloat(R.styleable.MultiSwitchButton_BackMeasureRatio, backMeasureRatio);
			animationDuration = ta.getInteger(R.styleable.MultiSwitchButton_AnimationDuration, animationDuration);
			fadeBack = ta.getBoolean(R.styleable.MultiSwitchButton_FadeBack, true);
			tintColor = ta.getColor(R.styleable.MultiSwitchButton_TintColor, tintColor);
			textOn = ta.getString(R.styleable.MultiSwitchButton_TextOn);
			textOff = ta.getString(R.styleable.MultiSwitchButton_TextOff);
			textMarginH = Math.max(textMarginH, backRadius / 2);
			textMarginH = ta.getDimension(R.styleable.MultiSwitchButton_TextMarginH, textMarginH);
			autoAdjustTextPosition = ta.getBoolean(R.styleable.MultiSwitchButton_AutoAdjustTextPosition, autoAdjustTextPosition);
			ta.recycle();
		}
	...
	public void setChecked(boolean checked,boolean hasAnimate){
		super.setChecked(checked);
	}
