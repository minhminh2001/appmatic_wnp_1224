 ...
 */
class CustomIcsLinearLayout extends LinearLayout {
    ...
    public CustomIcsLinearLayout(Context context, int themeAttr) {
        super(context);

        TypedArray a = context.obtainStyledAttributes(null, LL, themeAttr, 0);
        setDividerDrawable(a.getDrawable(CustomIcsLinearLayout.LL_DIVIDER));
