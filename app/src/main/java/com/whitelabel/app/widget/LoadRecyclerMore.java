 ...
 */
public class LoadRecyclerMore extends RecyclerView {
    /**
     * item 类型
     */
    ...
    public LoadRecyclerMore(Context context) {
        super(context);
        init();
    }

    public LoadRecyclerMore(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LoadRecyclerMore(Context context, AttributeSet attrs, int defStyle) {
