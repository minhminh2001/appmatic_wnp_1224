...
//        canvas.drawCircle(mCenterPoint.x, mCenterPoint.y, radius * mFloorScale, mFloorPaint);
        canvas.drawRoundRect(new RectF(mCenterPoint.x - radius * mFloorScale, mCenterPoint.y - radius * mFloorScale, mCenterPoint.x + radius * mFloorScale, mCenterPoint.y + radius * mFloorScale), JDataUtils.dp2Px(2),  JDataUtils.dp2Px(2), mFloorPaint);
