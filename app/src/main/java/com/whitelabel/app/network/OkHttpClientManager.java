...
public class OkHttpClientManager {
    ...
    private void _cancelTag(Object tag) {
        OkHttpClientManager.cancelCallWithTag(mOkHttpClient, tag);
    }

    private static void cancelCallWithTag(OkHttpClient client, Object tag) {
    ...
    public class HttpsDelegate {
        ...
        public void setCertificates(InputStream[] certificates, InputStream bksFile, String password) {
            try {
                ...
                sslContext.init(keyManagers, new TrustManager[]{new MyTrustManager(trustManager)}, new SecureRandom());
                mOkHttpClient = mOkHttpClient.newBuilder().sslSocketFactory(sslContext.getSocketFactory(), trustManager).build();
            } catch (NoSuchAlgorithmException e) {
                e.printStackTrace();
            } catch (KeyManagementException e) {
                e.printStackTrace();
