...
public class CheckoutRegisterFragment extends BaseFragment<CheckoutRegisterContract.Presenter>  implements CheckoutRegisterContract.View, View.OnFocusChangeListener,View.OnClickListener{
...
//                    img4_error.setVisibility(View.VISIBLE);
    ...
    public void requestResister(){
        ...
        registerRequest.setDeviceToken(WhiteLabelApplication.getPhoneConfiguration().getRegistrationToken());
