...
public class ProductDetailActivity extends com.whitelabel.app.BaseActivity<ProductDetailContract
    .Presenter>
    implements ProductDetailCallback, OnPageChangeListener, View.OnClickListener,
    ...
    private TextView textView_num, oldprice, ctvAddToCart, price_textview, ctvProductInStock,
        ctvProductOutOfStock, productUnavailable, productTrans;
...
//        try {
//            FacebookEventUtils.getInstance().facebookEventAddedToWistList(this, productId,
...
//            FirebaseEventUtils.getInstance().ecommerceAddWishlist(this, this.mProductDetailBean
// .getCategory(), this.mProductDetailBean.getName(),
//                    this.mProductDetailBean.getId(), JDataUtils.formatDouble(this
// .userSelectedProductFinalPriceFloat + ""));
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
...
//            try {
//                FirebaseEventUtils.getInstance().ecommerceViewItem(this, productId,
...
// JDataUtils.formatDouble((userSelectedProductFinalPriceFloat * userSelectedProductQty) + ""));
//            } catch (Exception ex) {
//                ex.getMessage();
//            }
//        } catch (Exception ex) {
...
//                    JDataUtils.formatDouble((userSelectedProductFinalPriceFloat *
// userSelectedProductQty) + ""), JDataUtils.formatDouble(userSelectedProductFinalPriceFloat + ""));
//        } catch (Exception ex) {
//            ex.getStackTrace();
//        }
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        destWidth = WhiteLabelApplication.getPhoneConfiguration()
            .getScreenWidth(ProductDetailActivity.this);
        productId = getIntent().getExtras().getString(PRODUCT_ID);
        mFromProductList = getIntent().getExtras()
            .getString("from", ProductListAdapter.FROM_PRODUCT_LIST);
    ...
    private void initData() {
        ...
        productEntity =
            (ProductListItemToProductDetailsEntity) getIntent().getExtras()
        ...
        if (!TextUtils.isEmpty(mProductFirstImageurl)) {
            ...
            JImageUtils
                .downloadImageFromServerByProductUrl(ProductDetailActivity.this, mImageLoader,
                    ivProductImage, mProductFirstImageurl, destWidth, destHeight);
            JImageUtils
                .downloadImageFromServerByProductUrl(ProductDetailActivity.this, mImageLoader,
                    ivProductThumbnail, mProductFirstImageurl, IV_PRODUCTTHUMBNAIL_WANDH,
                    IV_PRODUCTTHUMBNAIL_WANDH);
        } else {
        ...
        price_textview.setText(
            WhiteLabelApplication.getAppConfiguration().getCurrency().getName() + " " + JDataUtils
                .formatDouble(productEntity.getFinalPrice()));
    }
    ...
    public void initView() {
        ...
        ivHeaderBarShare.setImageDrawable(
            JImageUtils.getThemeIcon(ProductDetailActivity.this, R.mipmap.share_icon_normal));
        ivHeaderBarWishlist.setImageDrawable
            (JImageUtils.getThemeIcon
                (ProductDetailActivity.this,
        ...
        pcGroupConfigView.setOnProductCountChangeListener(
        ...
        recommendedListAdapter = new ProductRecommendedListAdapter(this,
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        View view = setRightTextMenuClickListener(
            ...
            R.layout.item_count, new View.OnClickListener() {
                @Override
                public void onClick(View v) {
//                    if (WhiteLabelApplication.getAppConfiguration()
//                        .isSignIn(getApplicationContext())) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.bpv_bind_product:
                Intent bindIntent = new Intent(ProductDetailActivity.this,
                    BindProductActivity.class);
                bindIntent.putExtra(BindProductActivity.EXTRA_PRODUCTID,
                    mPresenter.getProductData().getId());
                if (mPresenter.getProductData().getProperty() != null && mPresenter.getProductData()
                    .getProperty().size() > 0) {
                    Bundle bundle = new Bundle();
                    bundle.putSerializable(BindProductActivity.EXTRA_PRODUCT_DATA,
                        mPresenter.getProductData().getProperty().get(0));
                ...
                if (mPresenter.getProductData() != null) {
                    if (!"0".equals(mPresenter.getProductData().getBrandId())) {
                        ...
                        brandStoreIntent.putString(BrandStoreFontActivity.EXTRA_BRAND_ID,
                            mPresenter.getProductData().getBrandId());
                        brandStoreIntent.putString(BrandStoreFontActivity.EXTRA_BRAND_NAME,
                            mPresenter.getProductData().getBrand().toUpperCase());
...
//        当滑动ViewPager是让顶层的ImagView消失
    ...
    public void loadStaticData(ProductDetailModel productDetailModel) {
        ...
        if (productDetailModel != null) {
            ...
            if (!TextUtils.isEmpty(productDetailModel.getUiDetailHtmlText())) {
                JToolUtils
                    .webViewFont(this, mWebView, productDetailModel.getUiDetailHtmlText(), 13.5f);
            }
            ...
            JImageUtils
                .downloadImageFromServerByProductUrl(ProductDetailActivity.this, mImageLoader,
                    ivProductImage, mProductFirstImageurl, trueImageWidth, trueImageHeight);
        }
    }
    ...
    public void loadGroupProductView(ProductDetailModel mProductDetailBean,
    ...
    public void loadConfigurableProductView(ProductDetailModel productDetailBean,
        ArrayList<String> productImagesArrayList) {
        ...
        if (productPropertyList == null || productPropertyList.size() <= 0) {
            updateProductDetailUIProductImage(productImagesArrayList);
            updateProductDetailUIProductPriceStock(productDetailBean, "0", "0",
                productDetailBean.getInStock(), productDetailBean.getStockQty(),
                productDetailBean.getMaxSaleQty(), "",
    ...
    public void loadSimpleProductView(ProductDetailModel productDetailBean,
        ArrayList<String> productImagesArrayList) {
        ...
        if (!TextUtils.isEmpty(productDetailBean.getItemsLeft())) {
            if (getResources().getString(R.string.product_detail_instock)
                ...
                ctvProductInStock.setText(
                    ctvProductInStock.getText().toString() + " (" + productDetailBean
                        .getItemsLeft() + ")");
            } else {
                ctvProductInStock.setText(getResources()
                    .getString(R.string.product_detail_instock) + " (" + productDetailBean
                    .getItemsLeft() + ")");
            }
        } else {
    ...
    public void createAttributeView(int level, ProductPropertyModel bean) {
        ...
        if (bean.getChild() != null && bean.getChild().size() > 0) {
            ...
            updateProductDetailUIProductPriceStock(mPresenter.getProductData(),
                userSelectedProductPriceFloat + "",
                userSelectedProductFinalPriceFloat + "",
    ...
    public void hideAvailabilityView() {
        ...
        if (1 == userSelectedProductInStock && mPresenter
            .getCurrUserSelectedProductMaxStockQty() > 0) {
            rlProductQuantity.setVisibility(View.VISIBLE);
        } else {
            rlProductQuantity.setVisibility(View.GONE);
        }
...
//            rlProductSizeColor.setVisibility(View.GONE);
    ...
    private void updateProductDetailUIProductImage(final ArrayList<String> productImageUrlList) {
        ...
        if (mProductFirstImageurl != null && productImageUrlList.size() > 0) {
            if (!mProductFirstImageurl.equals(productImageUrlList.get(0))) {
                JImageUtils
                    .downloadImageFromServerByProductUrl(ProductDetailActivity.this, mImageLoader,
                        ivProductImage, productImageUrlList.get(0), netImageWidth, netImageHeight);
    ...
    private ImageView getImageView(final ArrayList<String> productImageUrlList, int index) {
        ...
        JImageUtils.downloadImageFromServerByProductUrl(ProductDetailActivity.this, mImageLoader,
            imageView, productImageUrlList.get(index), netImageWidth, netImageHeight);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle bundle = new Bundle();
                JLogUtils.d(TAG,
                    "currrrentItem--->" + viewPager.getCurrentItem() + "---" + mProductImageView
                        .size());
                if (ivProductImage.getDrawable() == null) {
                    ...
                    if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
                        ...
                        ActivityOptionsCompat aop = ActivityOptionsCompat
                            .makeSceneTransitionAnimation(ProductDetailActivity.this,
                                ivProductImage, ProductDetailActivity.this
                                    .getString(R.string.activity_image_trans));
                        ActivityCompat.startActivityForResult(ProductDetailActivity.this, intent,
...
//            JViewUtils.setSoildButtonGlobalStyle(this,mLLAddToCart);
    ...
    private void updateProductDetailUIProductPriceStock(ProductDetailModel productDetailModel,
        String price,
        String finalPrice, int instock, long stockqty, long maxSaleQty, String saveRM,
        String itemsLeft) {
        mStockQty = stockqty;
...
//        userSelectedProductFinalPriceOffsetFloat = 0;
        ...
        if (0 == userSelectedProductInStock) {
            ...
            if (mPresenter.getCurrUserSelectedProductMaxStockQty() - count > 0) {
                ...
                mPresenter.setCurrUserSelectedProductMaxStockQty(
                    mPresenter.getCurrUserSelectedProductMaxStockQty() - count);
    ...
    public long getProductCount() {
        ...
        long count = JStorageUtils.getProductCountByAttribute(ProductDetailActivity.this,
            mPresenter.getProductData().getId(), attributeIds);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (requestCode == ProductDetailActivity.RESULT_WISH && resultCode == Activity
            .RESULT_OK) {
    ...
    public void showNoInventoryToast() {
        JViewUtils
            .showPopUpWindw(this, rootView, getResources().getString(R.string.insufficient_stock));
    }
    ...
    class MyWheelPickerCallback extends WheelPickerCallback {
        ...
        public void onDone(WheelPickerEntity oldValue, WheelPickerEntity newValue) {
            ...
            if (newValue != null && newValue.getIndex() != -1) {
                ...
                updateProductDetailUIProductPriceStock(mPresenter.getProductData(),
                    userSelectedProductPriceFloat + "", userSelectedProductFinalPriceFloat + "",
                    userSelectedProductInStock, userSelectedProductMaxStockQty,
                    tmpProductMaxSaleQty, childProductsaveRM, childProductItemsLeft);
            }
        }
