...
public  class CategoryTreeExpandableAdapter1 extends ExpandableRecyclerAdapter<SVRAppserviceCatalogSearchCategoryItemReturnEntity> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case TYPE_HEADER:
                View convertView = LayoutInflater.from(context).inflate(R.layout.adapter_category_tree_group_item1, null);
                return new GroupViewHolder(convertView);
            case TYPE_CHILD:
            default:
                View convertView2 = LayoutInflater.from(context).inflate(R.layout.adapter_category_tree_child_item1, null);
