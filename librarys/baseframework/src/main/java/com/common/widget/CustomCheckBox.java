...
//        canvas.drawCircle(mCenterPoint.x, mCenterPoint.y, radius, mPaint);
        canvas.drawRect(mCenterPoint.x-radius,mCenterPoint.y-radius,mCenterPoint.x+radius,mCenterPoint.y+radius,mPaint);
    }
...
//        canvas.drawCircle(mCenterPoint.x, mCenterPoint.y, radius * mFloorScale, mFloorPaint);
        canvas.drawRoundRect(new RectF(mCenterPoint.x - radius * mFloorScale, mCenterPoint.y - radius * mFloorScale, mCenterPoint.x + radius * mFloorScale, mCenterPoint.y + radius * mFloorScale), dp2px(getContext(),2), dp2px(getContext(),2), mFloorPaint);

//        if (Build.VERSION.SDK_INT >=Build.VERSION_CODES.LOLLIPOP) {
//            canvas.drawRoundRect(mCenterPoint.x - radius * mFloorScale, mCenterPoint.y - radius * mFloorScale, mCenterPoint.x + radius * mFloorScale, mCenterPoint.y + radius * mFloorScale, 10, 10, mFloorPaint);
//        } else{
//            canvas.drawRect(mCenterPoint.x - radius * mFloorScale, mCenterPoint.y - radius* mFloorScale, mCenterPoint.x + radius* mFloorScale, mCenterPoint.y + radius* mFloorScale,mFloorPaint);
//        }
    }
