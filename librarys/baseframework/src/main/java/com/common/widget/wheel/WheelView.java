...
public class WheelView extends View {
    ...
    private int getItemHeight() {
        ...
        if (itemsLayout != null && itemsLayout.getChildAt(0) != null) {
            ...
            if(itemHeight==0){
                itemHeight= ScreenHelper.dip2px(getContext(),45);
            }

            return itemHeight;
        }
        itemHeight=getHeight() / visibleItems==0?ScreenHelper.dip2px(getContext(),45):getHeight()/visibleItems;
        if(itemHeight==0){
            itemHeight=ScreenHelper.dip2px(getContext(),45);
        }
        return itemHeight;
    ...
    private void drawShadows(Canvas canvas) {
        int height = (getHeight()-getItemHeight())/4*2;
